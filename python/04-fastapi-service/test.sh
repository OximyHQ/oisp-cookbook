#!/bin/bash
# Test script for python/04-fastapi-service
#
# This script:
# 1. Starts the OISP sensor
# 2. Runs the FastAPI service with test requests
...
# Run the FastAPI service (it will make test requests and exit)
echo ""
echo "Running FastAPI service with test requests..."
python app.py || true
